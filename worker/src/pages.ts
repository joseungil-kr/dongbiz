...
.volume-hero{padding:60px 0 42px;background:#F8FAFC}.volume-kicker{margin-bottom:10px;font-size:12px;font-weight:900;letter-spacing:.04em}.volume-hero h1{font-size:clamp(30px,5vw,48px);font-weight:900;letter-spacing:-.04em;line-height:1.2;color:#020617}.volume-hero p{font-size:16px;line-height:1.6}.volume-search{border:2px solid #2563EB;border-radius:24px;box-shadow:0 14px 32px rgba(37,99,235,.12)}.volume-search button{background:#03C75A}.volume-search button:hover{background:#02B350}.volume-search button:focus-visible{outline:3px solid #86EFAC;outline-offset:2px}@media (max-width:600px){.volume-hero{padding:46px 0 30px}.volume-search{border-radius:20px}}
`;
