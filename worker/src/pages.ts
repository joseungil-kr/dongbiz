...
export function siteNav(active: 'place' | 'volume' | 'ads' | 'blog', dark = false): string {
  ...
  return `<div class="site-head ${dark ? 'on-dark' : ''}"><div class="site-head-in">
    ...
    <nav class="site-nav">
      ${item('place', '/', '플레이스분석')}
      ${item('volume', '/keyword-volume', '네이버 키워드 검색량')}
      ${item('ads', '/ads', '광고컨설팅')}
...
export const SITE_NAV_CSS = `
  ...
  @media (max-width:720px){.site-head-in{gap:10px;padding:10px 16px}.brand{font-size:17px;flex:none}.brand .logo{width:31px;height:31px;border-radius:10px;font-size:16px}.site-nav{margin-left:0;flex:1;overflow-x:auto;scrollbar-width:none}.site-nav::-webkit-scrollbar{display:none}.site-nav a{white-space:nowrap;font-size:12px;padding:8px}.head-cta{display:none}}
  ...
  return `<footer class="site-foot"><div class="wrap">
    <div class="cols">
      ...
      <div>
        <h4>무료 도구</h4>
        <a href="/">내 매장 순위 진단</a>
        <a href="/keyword-volume">네이버 키워드 검색량</a>
...
const KEYWORD_VOLUME_STYLE = `
.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}
body{margin:0;background:#F8FAFC;color:#0F172A;font-family:Pretendard,system-ui,sans-serif}.volume-main{min-height:calc(100vh - 64px)}.volume-hero{padding:68px 0 42px;background:linear-gradient(135deg,#EFF6FF,#F8FAFC 62%,#ECFEFF)}.volume-wrap{width:min(100% - 40px,860px);margin:0 auto}.volume-kicker{margin:0 0 12px;color:#2563EB;font-size:13px;font-weight:800;letter-spacing:.05em}.volume-hero h1{margin:0;font-size:clamp(30px,5vw,48px);letter-spacing:-.055em;line-height:1.14}.volume-hero p{max-width:620px;margin:16px 0 0;color:#475569;font-size:16px;line-height:1.65}.volume-search{display:flex;gap:10px;margin-top:28px;padding:10px;background:#fff;border:1px solid #CBD5E1;border-radius:18px;box-shadow:0 12px 30px rgba(15,23,42,.07)}.volume-search input{min-width:0;flex:1;border:0;outline:0;background:transparent;padding:0 10px;font:inherit;font-size:16px;color:#0F172A}.volume-search input:focus-visible{outline:3px solid #93C5FD;border-radius:8px}.volume-search button,.volume-more,.volume-back{min-height:46px;border:0;border-radius:12px;font:inherit;font-weight:800;cursor:pointer;touch-action:manipulation;transition:background .2s,transform .2s,opacity .2s}.volume-search button{padding:0 20px;background:#2563EB;color:#fff}.volume-search button:hover{background:#1D4ED8}.volume-search button:disabled{opacity:.6;cursor:wait}.volume-search button:active,.volume-tag:active{transform:scale(.98)}.volume-content{padding:34px 0 68px}.volume-status{min-height:24px;margin:0 0 16px;color:#475569;font-size:14px;line-height:1.5}.volume-status.error{padding:13px 15px;border-radius:12px;background:#FEF2F2;color:#B91C1C}.volume-status.empty{padding:13px 15px;border-radius:12px;background:#FFFBEB;color:#92400E}.volume-result{background:#fff;border:1px solid #E2E8F0;border-radius:22px;padding:24px;box-shadow:0 8px 24px rgba(15,23,42,.04)}.volume-result[hidden]{display:none}.volume-result-head{display:flex;align-items:flex-start;justify-content:space-between;gap:16px}.volume-label{margin:0;color:#64748B;font-size:13px;font-weight:700}.volume-keyword{margin:5px 0 0;overflow-wrap:anywhere;font-size:clamp(23px,4vw,32px);letter-spacing:-.04em}.volume-back{padding:0 14px;background:#F1F5F9;color:#334155;white-space:nowrap}.volume-back:hover{background:#E2E8F0}.volume-back[hidden]{display:none}.volume-cards{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-top:22px}.volume-card{padding:16px;border-radius:15px;background:#F8FAFC;border:1px solid #E2E8F0}.volume-card strong{display:block;margin-top:6px;font-size:20px;letter-spacing:-.03em;font-variant-numeric:tabular-nums}.volume-card span{font-size:12px;color:#64748B;font-weight:700}.volume-note{margin:15px 0 0;color:#64748B;font-size:12.5px;line-height:1.6}.volume-related-title{margin:32px 0 6px;font-size:18px;letter-spacing:-.025em}.volume-related-help{margin:0 0 16px;color:#64748B;font-size:13px;line-height:1.55}.volume-tags{display:flex;flex-wrap:wrap;gap:9px}.volume-tag{min-height:44px;max-width:100%;border:1px solid #BFDBFE;border-radius:999px;background:#EFF6FF;color:#1E3A8A;padding:8px 13px;font:inherit;font-weight:750;line-height:1.15;overflow-wrap:anywhere;cursor:pointer;touch-action:manipulation;transition:background .2s,border-color .2s,transform .2s}.volume-tag:hover{background:#DBEAFE;border-color:#93C5FD}.volume-tag:focus-visible,.volume-more:focus-visible,.volume-back:focus-visible{outline:3px solid #93C5FD;outline-offset:2px}.volume-tag.size-1{font-size:13px}.volume-tag.size-2{font-size:14px}.volume-tag.size-3{font-size:16px}.volume-tag.size-4{font-size:18px}.volume-more{display:block;margin:18px auto 0;padding:0 18px;background:#fff;color:#1D4ED8;border:1px solid #BFDBFE}.volume-more:hover{background:#EFF6FF}.volume-more[hidden]{display:none}@media (max-width:600px){.volume-hero{padding:46px 0 30px}.volume-wrap{width:min(100% - 28px,860px)}.volume-search{padding:8px;gap:6px}.volume-search input{padding:0 7px}.volume-search button{padding:0 14px}.volume-result{padding:18px}.volume-result-head{align-items:center}.volume-cards{grid-template-columns:1fr;gap:8px}.volume-card{display:flex;align-items:center;justify-content:space-between;padding:14px 15px}.volume-card strong{margin:0;font-size:19px}.volume-related-title{margin-top:26px}}@media (prefers-reduced-motion:reduce){.volume-search button,.volume-tag,.volume-more,.volume-back{transition:none}}
`;

const KEYWORD_VOLUME_STYLE_OVERRIDES = `
.volume-hero{padding:58px 0 42px;background:#F8FAFC;text-align:center}.volume-wrap{width:min(100% - 48px,1024px)}.volume-kicker{margin-bottom:10px;font-size:13px;font-weight:900;letter-spacing:.02em;color:#2563EB}.volume-hero h1{font-size:clamp(32px,5vw,48px);font-weight:900;letter-spacing:-.055em;line-height:1.2;color:#020617}.volume-hero> .volume-wrap>p:not(.volume-kicker){max-width:672px;margin:16px auto 0;font-size:16px;line-height:1.65}.volume-search{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:12px;max-width:672px;margin:40px auto 0;padding:28px 32px;border:2px solid #2563EB;border-radius:24px;background:linear-gradient(180deg,#EFF6FF 0%,#fff 58%);box-shadow:0 14px 32px rgba(37,99,235,.13)}.volume-search label.sr-only{position:static;width:auto;height:auto;margin:0;overflow:visible;clip:auto;white-space:normal;grid-column:1/-1;text-align:left;color:#64748B;font-size:12px;font-weight:800}.volume-search input{min-height:56px;padding:0 16px;border:1px solid #E2E8F0;border-radius:16px;background:#fff}.volume-search input:focus-visible{outline:3px solid #93C5FD;outline-offset:1px}.volume-search button{min-height:56px;padding:0 32px;border-radius:16px;background:#03C75A;box-shadow:0 8px 18px rgba(3,199,90,.22)}.volume-search button:hover{background:#02B350}.volume-search button:focus-visible{outline:3px solid #86EFAC;outline-offset:2px}.volume-content{padding-top:26px}.volume-content .volume-wrap{max-width:896px}.volume-status{text-align:center}.volume-result{text-align:left}@media (max-width:600px){.volume-hero{padding:42px 0 28px}.volume-wrap{width:min(100% - 28px,1024px)}.volume-hero h1{font-size:32px}.volume-search{margin-top:30px;padding:22px 18px;border-radius:20px;gap:10px}.volume-search input{min-height:52px}.volume-search button{min-height:52px;padding:0 20px}.volume-content{padding-top:22px}}
`;
