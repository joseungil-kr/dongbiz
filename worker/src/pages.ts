...
export const SITE_NAV_CSS = `
  ...
  @media (max-width:720px){.site-head-in{gap:8px;padding:11px 16px}.brand{font-size:19px;flex:none}.brand .logo{width:34px;height:34px;border-radius:11px;font-size:17px}.site-nav{margin-left:0;flex:1;overflow-x:auto;scrollbar-width:none}.site-nav::-webkit-scrollbar{display:none}.site-nav a{white-space:nowrap;font-size:12px;padding:8px}.head-cta{display:none}}
