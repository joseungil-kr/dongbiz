...
export function renderKeywordVolumePage(): string {
  ...
  return shell({ title: '키워드 검색량 | 동네장사', description: '네이버 검색광고 API 기준 월간 PC·모바일 키워드 검색량과 관련 키워드를 확인하세요.', canonical: 'https://dongbiz.com/keyword-volume', active: 'volume', style: KEYWORD_VOLUME_STYLE, body });
}
