...
export const GUIDE_DROP: Guide = {
  slug: '플레이스순위하락',
  title: '플레이스 순위 하락 원인 · 여섯 갈래로 좁히는 법',
  desc: '네이버 플레이스 순위가 갑자기 떨어졌다면 원인은 대개 여섯 갈래 안에 있습니다. 갈래별 증상과 확인 순서를 실측 데이터와 함께 정리했습니다.',
  updated: '2026-09-08',
  answer:
  ...
  sections: [
    {
      h: '먼저 · 출렁임과 하락을 구분한다',
      img: '/images/guide_ranking_drop_1788922815111.jpg',
      p: [
  ...
  faqs: [
    ...
    },
    {
      ...
      a: '셋째 갈래인 경쟁 매장 강세일 가능성이 높습니다. 순위는 상대 평가이므로 내 매장이 그대로여도 경쟁 매장이 리뷰나 사진을 늘리면 밀려납니다.',
    },
    {
      q: '네이버 알고리즘이 바뀐 건지 어떻게 아나요?',
      a: '내 순위만 보면 알 수 없고 그 키워드 1페이지 전체를 봐야 합니다. 나만 크게 떨어졌다면 내 매장 문제이고, 비슷한 순위대가 함께 내려가고 다른 성격의 그룹이 올라왔다면 알고리즘 변경일 가능성이 높습니다. 방치된 업체까지 위로 올라오고 전체가 뒤죽박죽이라면 일시적 오류일 가능성이 크며 대개 24시간 안에 정상화됩니다.',
    },
    {
      q: '순위가 출렁일 때 정보를 고쳐야 하나요?',
      a: '돌아올 변동이라면 손대지 않는 편이 낫습니다. 순위가 원래대로 돌아온 뒤에도 바꿔놓은 것은 남아, 나중에 진짜 원인을 판단할 근거가 사라집니다.',
    },
    {
      q: '순위 회복까지 얼마나 걸리나요?',
    ...
    },
    {
      ...
      a: '상호나 전화번호와 목표 키워드를 넣으면 그 키워드의 1페이지 상위 6곳을 실시간으로 수집해 내 매장과 지표를 비교합니다. 어느 항목이 진입선 대비 얼마나 부족한지 숫자로 보여주므로, 여섯 갈래 중 어디에 해당하는지 좁힐 수 있습니다. 무료이며 로그인이 필요 없습니다.',
    },
  ],
  sources: [
